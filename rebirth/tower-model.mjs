import {beginFourth,stepFourth} from './fourth-job.mjs?v=monster-portrait-1';
import {beginThird,stepThird,ADVANCEMENT_BOSSES} from './advancement.mjs?v=monster-portrait-1';
...
import {CLASS_SKILLS,SECOND_SKILLS} from './data.mjs?v=monster-portrait-1';
