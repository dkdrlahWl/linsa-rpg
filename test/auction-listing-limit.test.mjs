...
try{
 ...
 console.log(JSON.stringify({suite:'AL8',assertions:checks,engine:usePg?'PostgreSQL independent connections':'PGlite sequential',concurrentSlotRace:usePg?'passed':'not tested here',productionDataUsed:false}));
}finally{
