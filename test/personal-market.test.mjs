...
try{
 ...
 const offers=[['jadeCube',12,5],['sunCube',30,5],['transcendStone',15,10],['downgradeProtect',6,5]].map(([resource,price,limit],slot)=>({slot,kind:'consumable',price,limit,item:{kind:'consumable',resource,quantity:1,name:resource}}));offers.push({...b.items[4],slot:4});
