...
import {initialState,execute,power,huntingRate,bestEquipment} from './engine.mjs?v=second-attack-1';
import * as D from './data.mjs?v=second-attack-1';
import {towerStep,TOWER_CLASSES} from './tower-model.mjs?v=second-attack-1';
