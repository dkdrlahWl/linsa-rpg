...
const make=(name,hits,interval,radius,mode,art,description,multiplier=1)=>{const total=(mode==='orbit'?25.2:18)*multiplier;return {name,type:'attack',hits,damage:total/hits,interval,range:1100,radius,mode,art,cooldown:30,description:description+' · 총 '+Math.round(total*100)+'% · 재사용 30초'};};
