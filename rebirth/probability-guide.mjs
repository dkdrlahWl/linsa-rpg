...
import {COOP_TIERS} from './coop-model.mjs?v=combat-catalog-1';
...
'<p>모든 필드·보스·탑·균열은 레벨·스타포스·선행 처치 조건 없이 입장합니다. 승리 보상 횟수는 무제한이며 연습·패배는 보상 없음. 아래 장비 확률은 승리 1회 기준입니다.</p>'+
...
table(['출처','레벨·직업·부위당 종류','디자인 조건부 확률'],[['필드','일반 2종','각 50%'],['보스','보스 전용 1종','100%']])+'<p>10~200레벨의 20구간 × 9부위 × 3종 = 직업당 540종, 5직업 총 2,700종. 보스 장비는 이 수량에 포함됩니다. 주간 보스 상자는 25%로 장비 1개를 지급하며, 해당 지역의 두 레벨을 각각 50%로 추첨합니다. 일일 보스는 표의 레벨로 10% 추첨합니다. 모든 보스 제한 시간은 90초입니다. <a href="boss-equipment.html">보스 장비 900종 전체 목록</a></p>'+
