...
(() => {
 ...
 function render(){
  ...
  $('blackMarketRatesNotice').textContent=snapshot?.ratesApplyNextRotation?'새 확률과 소모품은 다음 진열부터 적용됩니다. 현재 상품과 구매 기록은 유지됩니다.':'계정별 독립 진열 · 큐브는 최대 40% 할인 · 진열 동안 상품과 가격이 유지됩니다.';
 }
 ...
 function install(){
  ...
  modal.innerHTML='<header class="bm-header"><div><small>아는 사람만 찾는 거래소</small><h2 id="blackMarketTitle">암시장</h2></div><button type="button" id="blackMarketClose" aria-label="암시장 닫기">닫기</button></header>'+
   ...
   '<section id="blackMarketRatesPanel" hidden><h3>상품별 진열 확률</h3><p id="blackMarketRatesNotice"></p><div id="blackMarketRatesBody"></div><p>각 진열칸에서 상품 종류를 위 확률로 추첨합니다. 장비 부위는 7종 중 동일 확률이며 같은 부위·등급 안에서 이미 진열한 동일 장비는 제외합니다. 소모품은 서로 다른 칸에 중복 등장할 수 있습니다. 초월석 가격은 13~18, 하락방지권 가격은 4~8 정수의 정수값을 균등 추첨하며, 진열 동안 변하지 않습니다. 비취 큐브는 12~20, 태양 큐브는 30~50 정수이며 최대 할인은 40%입니다. 큐브·하락방지권은 진열당 5개, 초월석은 10개, 장비는 1개까지 구매할 수 있습니다. 정수는 선택한 수량의 구매가 확정될 때 사용됩니다.</p></section>'+
