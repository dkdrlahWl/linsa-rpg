...
(()=>{const load=()=>{const css=document.createElement('link');css.rel='stylesheet';css.href='/linsa-rpg/royal-ui.css?v=RG1';document.body.append(css);const script=document.createElement('script');script.src='/linsa-rpg/royal-ui.js?v=RG1';document.head.append(script);};if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',load,{once:true});else load();})();
