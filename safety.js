...
(() => {
  ...
  const bridge = {
    ...
    goldTransferTransaction:(recipient,amount,resource='gold')=>serverTransaction('gold-transfer',{action:'send',recipient,amount,resource,requestId:crypto.randomUUID()}),
