import {initialState,makeItem,power,huntingRate} from './engine.mjs?v=monster-portrait-1';
import {TIERS,STAGES,xpNeeded,BOSSES} from './data.mjs?v=monster-portrait-1';
