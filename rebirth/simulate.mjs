import {initialState,makeItem,power,huntingRate} from './engine.mjs?v=field-fragment-13';
import {TIERS,STAGES,xpNeeded,BOSSES} from './data.mjs?v=field-fragment-13';
