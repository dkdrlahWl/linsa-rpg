...
import {towerLobby,towerArena,TowerController} from './tower-client.mjs?v=tower-mobile-size-36';
...
import { power, huntingRate, battleEnemy } from "./engine.mjs?v=tower-mobile-size-36";
