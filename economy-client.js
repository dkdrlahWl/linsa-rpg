...
(() => {
 ...
 function install(){
  ...
  window.RinguEconomy={command,sync,paint};void import('/linsa-rpg/daily-wheel.js?v=DW1');paint(window.RinguCloud.initialEconomyEvents||[]);window.RinguCloud.initialEconomyEvents=[];
