import {canOpenChest,towerEncounter,TOWER_FLOORS,TOWER_CLASSES,towerStep,TOWER_STEP,upgradeTowerBattle} from './tower-model.mjs?v=monster-portrait-1';
import {CLASS_SKILLS,SECOND_SKILLS,THIRD_SKILLS,FOURTH_SKILLS} from './data.mjs?v=monster-portrait-1';
import {TowerInput,stickVector,projectPlayer} from './tower-input.mjs?v=monster-portrait-1';
import {TowerRenderer,image,asset,motionAsset,prepareCombatArt} from './tower-renderer.mjs?v=monster-portrait-1';
...
export class TowerController {
  ...
  accept(b){
    if(b.runId!==this.b.runId||b.tick<this.serverTick||(b.tick===this.serverTick&&!!b.chest===!!this.b.chest))return;
