...
(() => {
 ...
 const laurel='<svg class="rk-laurel" viewBox="0 0 72 68" aria-hidden="true" focusable="false"><g fill="none" stroke="currentColor" stroke-width="1.2"><path d="M29 62C10 55 8 32 17 18M43 62c19-7 21-30 12-44"/></g><g fill="currentColor"><path d="M22 57C12 56 8 49 8 45c7 1 11 5 14 12ZM17 47C7 45 5 38 7 34c6 4 8 7 10 13ZM15 35C8 30 9 22 12 20c3 6 4 10 3 15ZM16 25c-3-7 0-13 5-16 0 7-2 12-5 16ZM23 56c-1-7 1-11 5-14 2 7 0 11-5 14ZM18 44c1-7 4-11 9-12 0 6-4 10-9 12ZM17 32c2-6 7-8 12-8-2 6-7 8-12 8Z"/><path transform="translate(72 0) scale(-1 1)" d="M22 57C12 56 8 49 8 45c7 1 11 5 14 12ZM17 47C7 45 5 38 7 34c6 4 8 7 10 13ZM15 35C8 30 9 22 12 20c3 6 4 10 3 15ZM16 25c-3-7 0-13 5-16 0 7-2 12-5 16ZM23 56c-1-7 1-11 5-14 2 7 0 11-5 14ZM18 44c1-7 4-11 9-12 0 6-4 10-9 12ZM17 32c2-6 7-8 12-8-2 6-7 8-12 8Z"/></g></svg>';
 ...
 function install(){
  ...
  f.syncRanking=function(...args){if(pending)return pending;const top=list.scrollTop,startedMode=mode;list.setAttribute('aria-busy','true');pending=(async()=>{try{return await sync.apply(this,args);}finally{render();if(startedMode===mode)list.scrollTop=top;list.setAttribute('aria-busy','false');pending=null;}})();return pending;};
