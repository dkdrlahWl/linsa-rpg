...
(()=>{'use strict';
 ...
 window.installRinguAngel=g=>{
  ...
  const icon=window.RinguArt.icon;window.RinguArt.icon=(it,...args)=>{const t=template(it);return t?'<span class="rm-item-art angel-item-art" data-rarity="7"><img src="'+base+artFile(t)+'" alt="'+f.escapeHtml(t.name)+'" loading="lazy"></span>':icon(it,...args);};
