...
import {initialState,execute,power,huntingRate,bestEquipment} from './engine.mjs?v=enemy-interval-1';
import * as D from './data.mjs?v=enemy-interval-1';
import {towerStep,TOWER_CLASSES} from './tower-model.mjs?v=enemy-interval-1';
