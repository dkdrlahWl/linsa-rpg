...
export const CUBES={jade:{name:'비취 큐브',price:20,key:'jadeCube',rarities:[0,1,2,3]},sun:{name:'태양 큐브',price:50,key:'sunCube',rarities:[4,5,6,7]}};
...
const ratios=[.1,.25,.5,.75,1,1.35,1.75,2.25];
