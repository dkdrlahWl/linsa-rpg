import {initialState,makeItem,power,huntingRate} from './engine.mjs?v=wave-fourth-fix-3';
import {TIERS,STAGES,xpNeeded,BOSSES} from './data.mjs?v=wave-fourth-fix-3';
