...
import {towerArena} from './tower-client.mjs?v=weekly-first-1';
import {TowerRenderer,motionAsset,asset,image} from './tower-renderer.mjs?v=weekly-first-1';
...
export function coopArena(room){const me=room.members.find(m=>m.id===room.me);return towerArena({floor:[1,4,10][room.tier],classId:me.classId,runId:room.id,advanced:!!me.advanced}).replaceAll('시련의 탑','협동 균열').replace('towerLeaveConfirm','coopLeaveConfirm');}
const keyBits={KeyJ:1,KeyK:8,Space:4,KeyL:2};
