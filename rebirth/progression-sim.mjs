...
import {initialState,execute,power,huntingRate,bestEquipment} from './engine.mjs?v=fourth-fall-5';
import * as D from './data.mjs?v=fourth-fall-5';
import {towerStep,TOWER_CLASSES} from './tower-model.mjs?v=fourth-fall-5';
