import {TOWER_FLOORS,TOWER_CLASSES,towerStep,TOWER_STEP} from './tower-model.mjs?v=direction-art-28';
...
import {TowerRenderer,image,asset} from './tower-renderer.mjs?v=direction-art-28';
