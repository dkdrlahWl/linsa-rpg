...
'<p>모든 필드·보스·던전·탑·균열은 레벨·스타포스·선행 처치 조건 없이 입장합니다. 승리 보상 횟수는 무제한이며 연습·패배는 보상 없음. 아래 장비 확률은 승리 1회 기준입니다.</p>'+
table(['보스','주기','장비 레벨','장비 확률','확정 G','레드','지역 재료','추가'],D.BOSSES.map(b=>[b.name,b.weekly?'주간':'일일',b.gearLevel,pct(b.dropChance),b.gold,b.cubes,b.material,b.weekly?'블랙 2개 100%':'없음']))+
'<h3>협동 토벌</h3><p>승리할 때마다 실제 피해를 준 참가자에게 지급. 장비와 블랙 큐브는 독립 추첨.</p>'+
...
'<h3>던전</h3><p>각 던전 승리할 때마다 보상, 모두 100% 지급.</p>'+
...
table(['항목','확률·비용'],[['초기 잠재','레어 등급 · 3줄 100% · 무료'],['기존 장비','원래 등급·옵션 유지, 빈 줄만 현재 등급 레드 표로 보충'],['장비 제작','지역 보스 재료 24 + 파편 60 + (3,000+지역번호×500) G · 성공 100%'],['옛 파괴 장비 복원','12성으로 복원 · 성공 100%']])+
'<p>새 장비 옵션은 레드·레어 표를 사용합니다. 확장석과 개방 주문서는 삭제되었습니다. 기존 보유분은 확장석 1개당 파편 20개, 주문서 1개당 파편 3개로 자동 전환합니다. 제작은 내 직업·선택 부위·제작 레벨 고정, 디자인과 기본 수치는 랜덤입니다. 지역번호는 첫 지역 0부터 마지막 9입니다.</p>');
...
'<h3>탑</h3><p>첫 클리어는 아래 보상을 100% 지급. 재도전 승리마다 각 보상의 30%를 내림해서 지급합니다. 횟수 제한은 없습니다. 무작위 장비 드롭 없음.</p>'+
