import {beginFourth,stepFourth} from './fourth-job.mjs?v=cube-up-1';
import {beginThird,stepThird,ADVANCEMENT_BOSSES} from './advancement.mjs?v=cube-up-1';
...
import {CLASS_SKILLS,SECOND_SKILLS} from './data.mjs?v=cube-up-1';
